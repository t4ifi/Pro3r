<template>
  <div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div v-if="placaSeleccionada" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" @click="cerrarModal">
    ...
    <div v-if="mostrarConfirmarEliminar" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
